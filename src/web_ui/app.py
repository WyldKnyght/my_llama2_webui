...
def main():
    ...
    SHARE = bool(strtobool(os.getenv("SHARE", "False")))
    ...
    def generate(
        ...
        generator = llama2_wrapper.run(message, history, system_prompt, max_new_tokens, temperature, top_p, top_k)
        try:
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            stop_button.click(stop_ai)
            # TODO: Determine why stop_button doesn't work
